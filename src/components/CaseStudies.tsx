...
const caseStudies: CaseStudy[] = [
  {
    ...
    problem: "Low-connectivity communities lacked access to reliable health, agriculture, and civic information. Existing digital channels couldn't reach last-mile users on basic phones, and there was no way to provide real-time, personalized guidance without internet access.",
    userInsights: "Users needed voice-first, offline-capable solutions in local languages. Smartphone penetration was low but mobile phone ownership was high. Users on feature phones needed text-based AI interactions without data connectivity, and drop-off rates on existing USSD services were high due to poor UX.",
    hypothesis: "A voice-first AI platform using IVR logic trees could deliver personalized, lifesaving information at scale while creating a sustainable revenue model. A GenAI assistant layered on top could demonstrate demand for AI access in offline settings.",
    strategy: "Co-designed large-scale IVR programs with USAID, UNICEF, CIMMYT, and government partners. Built the GenAI assistant ('Ask Viamo Anything') as a voice-first experience on IVR, accessed via the same logic trees as USSD content, powered by a speech-to-text and text-to-speech pipeline. For the MVP and second iteration, simplified AI responses to plain English and built prompting guidance for users, since no local language LLMs existed at the time. The long-term roadmap included partnering with MNOs and local LLM labs to expand language support — the AVA feature in Pakistan, for example, already operates in Urdu.",
    experimentation: "Piloted the world's first offline GenAI assistant, generating ~90,000 user queries during its initial phase. Response latency was reduced from 1-minute responses to 3-second response times through iterative optimization. Implemented human-in-the-loop data validation — real people reviewing and validating AI-generated responses to ensure accuracy before scaling.",
    execution: "Led cross-functional teams to scale the platform nationally in Zambia, from inception to commercial launch. Integrated with existing USSD infrastructure, trained AI models on local content and language patterns. Restructured engagement and revenue systems to improve sustainability and scalability.",
    results: [
  ...
  },
  {
    ...
    problem: "Small service businesses such as salons, clinics, and studios in emerging markets are stuck between paper, WhatsApp, and rigid global SaaS that does not match how they actually run. They lack credible websites and tailored operational tools, and most off-the-shelf CRMs are too generic, too expensive, or too complex for their teams.",
    userInsights: "Owners need a credible online presence and a simple operational backbone, not feature-heavy software. Staff need lightweight, mobile-first workflows for booking, verification, and client notes. Clients want frictionless online booking without back-and-forth messaging.",
    ...
    strategy: "Founded Gassarro and launched Gassarrowellness, a Lusaka hair and nail salon, as the live testing ground. Designed and shipped a branded booking website covering services, gift cards, and careers, plus a custom CRM with authenticated staff access, appointment management, worker booking verification, and client surveys. Used the salon's day-to-day operations as continuous discovery for what service-business CRMs actually need.",
    ...
    results: [
      ...
      "Demonstrated ability to take a service-business product from zero to live, end-to-end",
    ],
  },
  {
